        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              values = [(0, _v2.default)(), req.body.firstname, req.body.lastname, req.body.phonenumber, req.body.address, req.body.email, hashPassword, false, (0, _moment2.default)(new Date()), (0, _moment2.default)(new Date())];
              _context.prev = 7;
              _context.next = 10;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return _index2.default.query(deleteQuery, [req.user.id]);
